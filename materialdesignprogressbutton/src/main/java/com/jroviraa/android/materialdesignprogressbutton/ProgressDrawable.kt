...
internal class ProgressDrawable(color: Int, private val mBorderWidth: Float) :
    Drawable(), Animatable {
    ...
    private val mAngleProperty: Property<ProgressDrawable, Float> =
        object : Property<ProgressDrawable, Float>(
            Float::class.java, "angle"
        ) {
            override fun get(`object`: ProgressDrawable): Float {
                return `object`.currentGlobalAngle
            }

            override fun set(
                `object`: ProgressDrawable,
                value: Float
            ) {
                `object`.currentGlobalAngle = value
            }
        }
    private val mSweepProperty: Property<ProgressDrawable, Float> =
        object : Property<ProgressDrawable, Float>(
    ...
    companion object {
        ...
        private val SWEEP_INTERPOLATOR: Interpolator =
